...
$schoolFolder = $_COOKIE['bookFisbn'];

// $IMConfig['images_dir'] = "/some/path/to/images/directory;
$IMConfig['images_dir'] = $image_folder_path;
...
if($userName==$myname){$canUpdate=true;}else{$canUpdate=false;}

$IMConfig['allow_upload'] = $canUpdate;
