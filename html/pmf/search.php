...
foreach ($AllSearch as $search) {
    ...
    $modified = ($chapter['modified'] > time() - $days_modified * 24 * 60 * 60) ? 1 : 0;
    $created = ($chapter['created'] > time() - $days_created * 24 * 60 * 60) ? 1 : 0;
    ...
    $modified = ($section['modified'] > time() - $days_modified * 24 * 60 * 60) ? 1 : 0;
    $created = ($section['created'] > time() - $days_created * 24 * 60 * 60) ? 1 : 0;
