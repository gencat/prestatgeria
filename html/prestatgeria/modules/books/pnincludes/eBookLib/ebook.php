...
class ebook{
	...
	public function setDcIdentifier($identifier, $index = null){
		...
		$this->ebookData->ncx->addMeta('dtb:uid',$identifier);
		$this->ebookData->ncx->addMeta('dtb:depth','1');
		$this->ebookData->ncx->addMeta('dtb:totalPageCount','0');
		$this->ebookData->ncx->addMeta('dtb:maxPageNumber','0');
		if($this->useSessions){
			$_SESSION['data'] = serialize($this->ebookData);
		}
	}
