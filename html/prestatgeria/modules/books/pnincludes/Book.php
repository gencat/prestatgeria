...
class Book
{
	...
	*/
	public static function xml2book($filename)
	{
		...
		if (!$doc->schemaValidate('modules/books/pnincludes/book.xsd')){
	...
	*/
	...
	public function getSchoolCode() {return $this->schoolCode;}
	...
	public function getAdminEmail() {return $this->adminEmail;}
	public function getShowSearch() {return $this->showSearch;}
	public function getLang() {return $this->lang;}
	public function getTheme() {return $this->theme;}
	public function getHtmlEditor() {return $this->htmlEditor;}
	...
	public function getImageFolder() {return '/centres/' . $this->schoolCode . '_' . $this->bookId . '/';}
	
	public function countChapters() {return count($this->chapters);}
	...
	public function setSchoolCode($schoolCode) {$this->schoolCode = $schoolCode;}
	...
	public function setAdminEmail($adminEmail) {$this->adminEmail = $adminEmail;}
	...
	public function setHtmlEditor($htmlEditor) {$this->htmlEditor = $htmlEditor;}
	public function setDescriptors($descriptors) {$this->descriptors = $descriptors;}
	
	public function pushChapter($chapter) {array_push($this->chapters,$chapter);}
	public function setChapter($i,$chapter) {array_splice($this->chapters,$i,1,array($chapter));}
	public function removeChapter($i) {array_splice($this->chapters,$i,1);}
	public function addPage($numchapter,$page) {$this->chapters[$numchapter]->addPage($page);}
	...
	*/
	public function book2html($bookpath)
	{
		...
		// images
		copydir(pnModGetVar('books','serverImageFolder') . '/' . $this->schoolCode . '_' . $this->bookId,$bookpath . 'book_images');	// 'images'
	...
	*/
	...
	{	if (!mkdir($filename)) {
		...
		Loader::RequireOnce("modules/books/pnincludes/eBookLib/ebook.php");
		$ebook = new ebook();
		...
		// images
		copydir(pnModGetVar('books','serverImageFolder') . '/' . $this->schoolCode . '_' . $this->bookId,$ebook->getContentLoc() . 'images');
