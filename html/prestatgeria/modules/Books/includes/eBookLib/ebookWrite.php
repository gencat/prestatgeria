...
class ebookWrite {
    ...
    private function buildFiles() {
        ...
        $this->addManifestItem('ncx', 'toc.ncx', 'application/x-dtbncx+xml');
        $this->setSpineToc('ncx');
        ...
        //Make and Write the toc.ncx file
        $this->writeFile($this->ebookData->contentFolder . "toc.ncx", $this->ebookData->ncx->writeNCX());
    }
...
<container version=\"1.0\" xmlns=\"urn:oasis:names:tc:opendocument:xmlns:container\">
  <rootfiles>
    ...
    private function makeBuildFolder() {
        ...
        global $ZConfig;
        $tempdir = $ZConfig['System']['temp'] . '/books/';
    ...
    public function addContentFile($fileLoc, $name, $mime, $subDir = null, $fallBackId = null) {
        ...
        if ((!empty($fileLoc))) {
            ...
            //$this->ebookData->ncx->addNavPoint($name,$name,$filename);
