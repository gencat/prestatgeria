...
// XTEC ************ MODIFICAT -> Adaptation to he new ldap server
// 2012.06.13 @mmartinez
    $ldaprdn  = pnModGetVar('iw_AuthLDAP', 'authldap_searchattr').'='.$args['uname'].','.pnModGetVar('iw_AuthLDAP', 'authldap_basedn');    // ldap rdn or dn
// *********** ORIGINAL
...
// XTEC ************ MODIFICAT -> Adaptation to he new ldap server
// 2012.06.13 @mmartinez
    if (!$ldap_sr = ldap_search($ldap_ds, $ldaprdn, pnModGetVar('iw_AuthLDAP', 'authldap_searchattr') . '=' . DataUtil::formatForStore($args['uname']), $justthese)) {
// *********** ORIGINAL
