...
// ----------------------------------------------------------------------
$ZConfig['DBInfo']['databases']['default']['host'] = $presta['dbhost'];
$ZConfig['DBInfo']['databases']['default']['user'] = $presta['dbuser'];
$ZConfig['DBInfo']['databases']['default']['password'] = $presta['dbpass'];
$ZConfig['DBInfo']['databases']['default']['dbname'] = $presta['dbname'];
...
$ZConfig['DBInfo']['databases']['book']['host'] = $presta['dbhost'];
$ZConfig['DBInfo']['databases']['book']['user'] = $presta['dbuser'];
$ZConfig['DBInfo']['databases']['book']['password'] = $presta['dbpass'];
$ZConfig['DBInfo']['databases']['book']['dbname'] = $presta['dbname'];
$ZConfig['DBInfo']['databases']['book']['dbdriver'] = 'mysql';
$ZConfig['DBInfo']['databases']['book']['dbtabletype'] = 'innodb';
$ZConfig['DBInfo']['databases']['book']['charset'] = 'utf8';
$ZConfig['DBInfo']['databases']['book']['collate'] = 'utf8_general_ci';
