<?php /* Smarty version 2.6.26, created on 2013-05-07 11:35:51
         compiled from books_block_lastEntries.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'gt', 'books_block_lastEntries.tpl', 9, false),)), $this); ?>
...
?>
    ...
    <div class="blocValue">
        <?php echo $this->_tpl_vars['book']['bookPages']; ?>
 <?php echo smarty_function_gt(array('text' => 'Pàg.'), $this);?>

    </div>
    <?php endforeach; endif; unset($_from); ?>
    <div class="more">
        <a href="#" onclick="javascript:catalogue('lastEntry','',1,'',1)">
