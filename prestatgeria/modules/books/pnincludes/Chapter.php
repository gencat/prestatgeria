...
class Chapter
{
	...
	function getNotifyEmail() {return $this->notifyEmail;}
	function getEntriesPage() {return $this->entriesPage;}
	function getShowName() {return $this->showName;}
	function getShowEmail() {return $this->showEmail;}
	function getShowUrl() {return $this->showUrl;}
	function getShowImage() {return $this->showImage;}
	function getFormatPage() {return $this->formatPage;}
	function getPages() {return $this->pages;}
	function getUnnaproved() {return $this->unnaproved;}
	
	function countPages() {return count($this->pages);}
	
	function setChapterId($chapterId) {return $this->chapterId = $chapterId;}	
	function setName($name) {$this->name = $name;}
	function setDescription($description) {$this->description = $description;}
	function setImage($image) {$this->image = $image;}
	function setPermission($permission) {return $this->permission = $permission;}
	function setNotifyEmail($notifyEmail) {return $this->notifyEmail = $notifyEmail;}
	function setEntriesPage($entriesPage) {return $this->entriesPage = $entriesPage;}
	function setShowName($showName) {return $this->showName = $showName;}
	function setShowEmail($showEmail) {return $this->showEmail = $showEmail;}
	function setShowUrl($showUrl) {return $this->showUrl = $showUrl;}
	function setShowImage($showImage) {return $this->showImage = $showImage;}
	function setFormatPage($formatPage) {return $this->formatPage = $formatPage;}
	
	function addPage($page) {array_push($this->pages,$page);}	
	function delPage($page) {array_pop($this->pages);}
	function addUnnaproved($unnaproved) {array_push($this->unnaproved,$unnaproved);}
	function delUnnaproved($unnaproved) {array_pop($this->unnaproved);}
	function setPage($i,$page) {array_splice($this->pages,$i,1,array($page));}
	function setUnnaproved($i,$unnaproved) {array_splice($this->unnaproved,$i,1,array($unnaproved));}
